...
final secretCodeOldProvider =
    StateNotifierProvider<SecretCodeOldController, String>(
        (_) => SecretCodeOldController());

class SecretCodeOldController extends StateNotifier<String> {
  SecretCodeOldController() : super('') {
